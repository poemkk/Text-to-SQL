...
def main():
    ...
    ap.add_argument("--schema_char_limit", type=int, default=1200)
    ap.add_argument("--topk_table", type=int, default=3)
    ap.add_argument("--topk_col", type=int, default=6)
    ap.add_argument("--topk_fk", type=int, default=6)
