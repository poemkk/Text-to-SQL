...
SCORED_PATH = Path("runs/outputs/a2v/scored_spider500.jsonl")
SELECTED_PRIORITY_PATH = Path("runs/outputs/a2v/selected_spider500.jsonl")
SELECTED_VOTE_PATH = Path("runs/outputs/a2v/selected_vote_spider500.jsonl")
OUT_PATH = Path("runs/outputs/a2v/summary_spider500.md")
...
def main():
    ...
    lines = []
    lines.append("# A²V-SQL Spider500 Summary")
    lines.append("")
