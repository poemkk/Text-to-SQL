...
SCORED_PATH = Path("runs/outputs/a2v/scored_spider100.jsonl")
SELECTED_PRIORITY_PATH = Path("runs/outputs/a2v/selected_spider100.jsonl")
SELECTED_VOTE_PATH = Path("runs/outputs/a2v/selected_vote_spider100.jsonl")
OUT_PATH = Path("runs/outputs/a2v/summary_spider100.md")
...
def main():
    ...
    lines = []
    lines.append("# A²V-SQL Spider100 Summary")
    lines.append("")
